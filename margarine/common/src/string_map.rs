...
impl<'str> StringMap<'str> {
    ...
    pub const ISIZE : StringIndex = StringIndex(10);
    pub const U8  : StringIndex = StringIndex(11);
    pub const U16 : StringIndex = StringIndex(12);
    pub const U32 : StringIndex = StringIndex(13);
    pub const U64 : StringIndex = StringIndex(14);
    pub const USIZE : StringIndex = StringIndex(15);
    pub const F32 : StringIndex = StringIndex(16);
    pub const F64 : StringIndex = StringIndex(17);
    pub const UNIT : StringIndex = StringIndex(18);
    pub const NEVER : StringIndex = StringIndex(19);
    pub const OK : StringIndex = StringIndex(20);
    pub const ERR : StringIndex = StringIndex(21);
    pub const SOME : StringIndex = StringIndex(22);
    pub const NONE : StringIndex = StringIndex(23);
    pub const SELF : StringIndex = StringIndex(24);
    pub const NEW : StringIndex = StringIndex(25);
    pub const INVALID_IDENT : StringIndex = StringIndex(26);
    pub const RANGE : StringIndex = StringIndex(27);
    pub const MIN   : StringIndex = StringIndex(28);
    pub const MAX  : StringIndex = StringIndex(29);
    pub const COUNT : StringIndex = StringIndex(30);
    pub const TUPLE : StringIndex = StringIndex(31);
    pub const PTR : StringIndex = StringIndex(32);
    pub const RESULT: StringIndex = StringIndex(33);
    pub const OPTION: StringIndex = StringIndex(34);
    pub const T: StringIndex = StringIndex(35);
    pub const A: StringIndex = StringIndex(36);

    pub const ITER_NEXT_FUNC : StringIndex = StringIndex(37);
    pub const ITER_MUTATE : StringIndex = StringIndex(38);
    ...
    pub fn with_capacity(cap: usize, arena: &'str Arena) -> Self {
        ...
        assert_eq!(s.insert("isize"), Self::ISIZE);
        ...
        assert_eq!(s.insert("usize"), Self::USIZE);
